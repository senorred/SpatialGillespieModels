...
% The model will later be manipulated by introducing crowders to the space. 
%
...
%
% Version Description: Tracks ribos, tracks mRNA, no random mRNA or
% crowders yet.
...
%% Initialize Model
    ...
    mRNATrack = zeros(1,2,length(tspan)); %initially only one mRNA, must concatenate as they are born
    %mRNATrack=[];
    
%         %Randomly distribute Ribos into compartments
%     for i = 1:Ribosomes
