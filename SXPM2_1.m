...
% most likely voxel and running through the possible reactions. Added
% mRNASpace and RiboSpace to each iteration. Dubious "shortcut" by calling
% all reaction propensities for a(CrowdSpace) ==0, since they don't move,
% and no reactions are possible?
...
%% Model
    ...
    while T < tmax %Run gillespie until time is up
        ...
        % type, 'q'
        q=[];
        avec=reshape(a,[1,(VoxLength*VoxWidth*6)]);
        ...
        elseif q>=2 && q<=5  %moves Ribosome from chosen voxel
